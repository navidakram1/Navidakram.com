...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0e15] text-gray-100 relative">
      ...
      {/* ================= MOBILE STICKY TOP HEADER & 5-TAB BAR (MATCHING TARGET DESIGN) ================= */}
      ...
      <main className="max-w-[1400px] mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 lg:py-12">
        <div className="flex flex-col xl:flex-row items-center xl:items-start gap-6 sm:gap-8 justify-center">
          ...
          <div id="content-panel" className="w-full flex-1 max-w-4xl min-w-0">
            <div className="bg-[#1e202d] rounded-[28px] sm:rounded-[36px] border border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.6)] p-5 sm:p-8 lg:p-10 transition-all duration-300">
